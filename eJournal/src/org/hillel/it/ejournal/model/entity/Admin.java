...
public class Admin extends Teacher {
	...
	public int addStudent (String name, String surname, Date birthDate, Sex sex, int schoolClassId, int groupId) {
		return 0;
	}
	...
	public int addLesson (int subjectId, int schoolClassid, int groupId, int dayNumber, int lessonNumber) {
		return 0;
	}
